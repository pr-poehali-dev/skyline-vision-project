...
const achievements = [
  { icon: <Headphones className="w-6 h-6" />, label: "Лет на рынке", value: "5+" },
  { icon: <Music className="w-6 h-6" />, label: "Созданных сайтов", value: "500+" },
  { icon: <Mic2 className="w-6 h-6" />, label: "Довольных клиентов", value: "200+" },
  { icon: <Award className="w-6 h-6" />, label: "Шаблонов дизайна", value: "50+" },
];
    ...
    <section ref={ref} id="about" className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Почему мы?</h2>
            <p className="text-lg mb-6 text-zinc-300">
              Мы специализируемся на создании сайтов для музыкальной индустрии. Понимаем специфику работы продюсеров, битмейкеров и лейблов.
            </p>
            <p className="text-lg mb-8 text-zinc-300">
              От простого портфолио до полноценной платформы продажи битов — мы создаём решения, которые помогают музыкантам зарабатывать на своём творчестве.
            </p>
